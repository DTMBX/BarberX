...
(function() {
  ...
  function initMobileDrawer() {
    ...
    const expandableLinks = drawer.querySelectorAll('.drawer-nav__item--expandable .drawer-nav__link');
    ...
    const drawerLinks = drawer.querySelectorAll('.drawer-nav__link:not(.drawer-nav__item--expandable .drawer-nav__link), .drawer-submenu__link');

# Law School Clinical Partnership Email Template
...
P.S. Here's a 3-minute demo video: [YouTube link]

---

## Email #2: Follow-Up (7 Days Later)

**Subject:** Re: Free Partnership for [Law School] Criminal Defense Clinic

**Body:**

Hi Professor [Last Name],

I wanted to follow up on my partnership proposal from last week.
...
## Email #3: Value-Add Follow-Up (14 Days Later)

**Subject:** Free CLE Resource for Your Clinic Students
...
**No strings attached**—just a resource your students might find helpful.

Feel free to share it in clinic seminar or include in student materials.

If you ever want to revisit the partnership, I'm here.
...
## Email #4: Student Success Story (30 Days Later)

**Subject:** Case Study: Law Student Uses AI to Win "Unwinnable" Case
...
## Email #5: Faculty Research Collaboration (45 Days Later)

**Subject:** Research Opportunity: AI in Legal Education
...
Interested? Let's set up a call to brainstorm.
...
## Email #6: Final Outreach (60 Days Later)
...
Create a CSV to track all outreach:

**File:** `outreach/partnership-outreach-tracker.csv`

```csv
Organization Name,Contact Name,Title,Email,Outreach Date,Email Number,Response,Status,Next Action,Notes
Georgetown Law,Prof. Jane Smith,Clinical Professor,jsmith@georgetown.edu,2026-01-28,Email #1,No response,Pending,Follow-up 2/4,Criminal Defense Clinic
NACDL,John Doe,Executive Director,jdoe@nacdl.org,2026-01-28,Email #1,No response,Pending,Follow-up 2/4,National bar association
NYU Law,Prof. Sarah Lee,Clinic Director,slee@nyu.edu,2026-01-29,Email #1,No response,Pending,Follow-up 2/5,Scheduled call 2/3
```
...
- **Email:** Contact email
- **Outreach Date:** When Email #1 was sent
- **Email Number:** Which email in sequence (1-6)
- **Response:** "Interested," "Not interested," "No response"
- **Status:** "Pending," "Active conversation," "Partnership signed," "Declined"
- **Next Action:** Follow-up date or next step
- **Notes:** Any relevant context

---

**File Location:** outreach/email-template-law-school.md  

...
1. [Why New Jersey Building Codes Matter](#why-codes-matter)
2. [NJ HIC Licensing Requirements](#hic-licensing)
3. [Permit Requirements for Tile Showers](#permit-requirements)
4. [TCNA Handbook Standards](#tcna-standards)
5. [Waterproofing Code Requirements](#waterproofing-codes)
6. [Inspection Process & Checkpoints](#inspection-process)
7. [Common Code Violations](#common-violations)
...
## NJ HIC Licensing: Your Shield Against Shady Characters {#hic-licensing}
...
**Step 2:** Enter the contractor's name or license number **Step 3:** Look for:
...
🚩 **"My license is being processed"** Translation: "I don't have one and I'm
hoping you won't check." (It's illegal to work without an active license.)

🚩 **Refuses to provide license number** Why? What's he hiding? (Hint:
everything.)

🚩 **"Cash discount—no receipt"** Ah yes, tax evasion. When the job goes bad,
good luck proving you paid him.

🚩 **"We don't need a permit for this"** Oh, we absolutely do. He just doesn't
want an inspector seeing his "work."

🚩 **Can't provide proof of insurance** You know what's fun? Getting sued when
someone falls off a ladder in your house. Just kidding—that's not fun at all.
...
## Permit Requirements: The Part Everyone Tries to Skip (Don't) {#permit-requirements}
...
- Removing or moving walls (structural changes need an engineer's stamp)
...
**Step 1:** Submit plans to your local building department **Step 2:** Pay the
fee ($150-500 depending on your town) **Step 3:** Wait 3-10 business days for
approval (grab coffee, be patient) **Step 4:** Post the permit placard at the
job site (inspectors love this thing) **Step 5:** Schedule inspections (rough-in
first, final after tile)
...
- Waterproofing specs (what membrane system we're using)
- Electrical plans (if you're adding lights or outlets)
...
- End of project: Final inspection (after tile, before you shower in it)
...
## TCNA Handbook: The Tile Installer's Bible {#tcna-standards}
...
> flood-tested and documented" **Wrong Answer:** "Uh... it's waterproof paint?"
...
❌ **WRONG:** "I'll just use mastic—it says 'waterproof' on the bucket!" ✅
**RIGHT:** ANSI A118.10 membrane installed **before** any tile goes up

❌ **WRONG:** "I painted on some waterproof sealer from Home Depot." ✅
**RIGHT:** Factory-manufactured membrane system with a 10+ year track record

❌ **WRONG:** "The membrane stops at the curb, right?" ✅ **RIGHT:** Membrane
continues over the curb and down 3-4" on the outside

❌ **WRONG:** "I'll just caulk the corners—that's waterproof enough." ✅
...
- Blocking for grab bars, shelves, bench
...
- Plumbing doesn't leak (yes, they test it)
- Blocking is solid (grab bars need to hold 250+ lbs)

**Pass Rate:** ~90% (this one's pretty straightforward)
...
- No gaps, voids, or missed spots
- Transitions properly sealed

**Pass Rate:** ~75% (this is where amateurs get caught)

**Inspection #3: Final** (After Tile Complete)
...
- No cracked or damaged tiles
- All fixtures work (turn on water, check for leaks)
- Door/curtain rod installed if applicable

**Pass Rate:** ~85% (most failures are minor fixes)
...
- Flood test photos with timestamp (if you did one)
...
**The Fix:** Install an ANSI A118.10 compliant membrane system. Follow the
manufacturer's instructions **exactly**. Not "kinda close"—**exactly**.
...
**The Fix:** Verify slope with a 4-foot level during installation. Rebuild the
pan if it's not draining.
...
**The Fix:** Stop work immediately. Get the proper permit. Pay the fine. Don't
be this person.
...
**The Fix:** Homeowner is liable. You'll need to hire a licensed contractor to
**redo the work** with permits. Ouch.
...
**The Fix:** Tear out, install cement board or foam board, waterproof, re-tile.

**Cost of Mistake:** $6,000-12,000

---

### Other Violations (The Oops Moments):

**#6: Improper Drain** - Wrong slope, no weep holes, bad seal **#7: Missing
Vapor Barrier** - No 6-mil poly behind cement board **#8: Wrong Mortar** - Using
mastic in wet areas (stop it) **#9: Electrical Violations** - Outlet too close
to water, no GFCI **#10: Structural Issues** - Sagging joists, missing blocking

The pattern? **Shortcuts lead to expensive do-overs.**
...
**1. Safety** Is this shower going to hurt someone? Will it leak and cause mold?
Is the structure sound?

**2. Code Compliance** Did you follow the rules? (Not "kinda"—actually follow
them.)

**3. Professionalism** Is this contractor competent? Is the work site organized?
Do they know what they're doing?

**4. Documentation** Can you prove you did it right? Do you have permits, specs,
photos?
...
- Take notes if they point out concerns
...
## Code Compliance Checklist (Your Pre-Inspection Tool) {#compliance-checklist}

Copy this checklist. Use it before every inspection. Thank me later.

### ✅ **Pre-Rough-In Checklist**

- [ ] Permit obtained and posted at job site
- [ ] Contractor HIC license active and current
- [ ] Plans available on-site
- [ ] Studs 16" on center, plumb and straight
- [ ] Blocking installed for grab bars (solid 2x8 minimum)
- [ ] Blocking for valve, shower head, accessories
- [ ] Vapor barrier installed (6-mil poly minimum)
- [ ] Cement board installed per manufacturer specs
- [ ] Drain rough-in positioned correctly
- [ ] Supply lines properly supported
- [ ] No plumbing leaks (pressure test completed)

### ✅ **Pre-Waterproofing Inspection Checklist**

- [ ] ANSI A118.10 compliant membrane selected
- [ ] Manufacturer's installation instructions on-site
- [ ] Pre-formed corners installed (inside and outside)
- [ ] Membrane extends 6" above shower head height
- [ ] Membrane continues over curb and down 3-4"
- [ ] All seams overlapped per manufacturer specs
- [ ] Transitions properly sealed
- [ ] Flood test completed (2" water, 24 hours, zero leaks)
- [ ] Flood test photos with timestamp
- [ ] Drain assembly properly bonded to membrane

### ✅ **Pre-Final Inspection Checklist**

- [ ] Tile properly adhered (no hollow sounds when tapped)
- [ ] Grout fully cured (3-7 days minimum)
- [ ] Proper slope maintained (1/4" per foot to drain)
- [ ] No cracked or damaged tiles
- [ ] All fixtures installed and functional
- [ ] Hot/cold water working correctly
- [ ] Drain flows properly (no standing water)
- [ ] Caulking complete around tub/shower perimeter
- [ ] Silicone caulk at change-of-plane (where walls meet floor)
- [ ] Door/curtain rod installed if applicable
- [ ] Work site cleaned and debris removed
...
**📞 Call us:** [Your Phone Number] **📧 Email:** [Your Email] **🌐 Website:**
[Evident.icu](https://www.evident.icu)
...
**Last Updated:** January 27, 2026 **Author:** Tyler, Tillerstead LLC **License
Verification:**
...
4. Re-inspect within 10 days
5. Pay re-inspection fee
...
## Code Compliance Checklist {#compliance-checklist}

### Pre-Construction

- [ ] Licensed HIC contractor hired (verify license)
- [ ] Permit obtained and approved
- [ ] Plans match approved drawings
- [ ] All materials comply with codes
- [ ] Homeowner's insurance notified

### Rough-In Phase

- [ ] Framing: 16" OC studs
- [ ] Blocking installed for fixtures
- [ ] Vapor barrier: 6-mil poly installed
- [ ] Plumbing rough-in complete
- [ ] Shower pan pre-sloped (if mortar bed)
- [ ] Drain assembly proper type
- [ ] Rough-in inspection passed

### Waterproofing Phase

- [ ] Cement board installed (1/2" minimum)
- [ ] ANSI A118.10 membrane selected
- [ ] Manufacturer instructions followed
- [ ] Corners: pre-formed pieces used
- [ ] Height: 6" above shower head
- [ ] Seams: proper overlap maintained
- [ ] Flood test: 24 hours completed
- [ ] Photos: before tile documentation
- [ ] Waterproofing inspection (if required)

### Tile Installation Phase

- [ ] Mortar: ANSI A118.4 or A118.15
- [ ] Thinset coverage: 95% minimum
- [ ] Slope: 1/4" per foot maintained
- [ ] Layout: proper pattern
- [ ] Cuts: clean and accurate
- [ ] Grout: ANSI A118.6 minimum
- [ ] Cure time: 3-7 days
- [ ] Sealant: 100% silicone at changes of plane

### Final Inspection

- [ ] All tile installed and grouted
- [ ] Fixtures installed properly
- [ ] Caulking complete
- [ ] Cleanup complete
...
- Resale requires disclosure
- Most homeowners hire professionals due to complexity
...
Rush permits available in some municipalities for additional fee.
...
4. Remove work for inspection (walls opened)
5. Possible fines ($500-2,000 per day)
6. Difficulty selling home
...
- Some attend TCNA training courses
...
Example: Crooked tiles aren't a code violation, but missing waterproofing is.
...
✅ **Always hire a licensed HIC contractor** (verify at NJ Consumer Affairs) ✅
**Obtain permits before work begins** (5-15 day process) ✅ **Use ANSI A118.10
waterproofing** (not optional) ✅ **Follow TCNA methods** (industry standard) ✅
**Schedule inspections promptly** (rough-in, final minimum) ✅ **Document
everything** (photos, receipts, permits)
...
**Call/Text:** [(609) 862-8808](tel:+16098628808) **Service Areas:** Atlantic,

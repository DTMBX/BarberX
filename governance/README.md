...
3. Review license compatibility:
   - ✅ **Approved**: MIT, BSD-2/3, Apache-2.0, LGPL (as subprocess), Perl Artistic
   - ⚠️ **Review Required**: GPL, AGPL (copyleft obligations)
...
- ✅ Deprecated PyPDF2 replaced with pypdf
...
- ⚠️ **Medium**: Metadata extraction (proposed MediaInfo/ExifTool)
